...
const Welcome = () => {
  // Check if user is logged in (you'll implement this with Lovable Cloud later)
      ...
      <div className="max-w-4xl w-full text-center space-y-8 animate-in fade-in duration-1000">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <div className="relative bg-gradient-primary p-8 rounded-3xl shadow-large">
        ...
        <div className="pt-8">
          <Button 
            size="lg" 
            className="bg-gradient-primary hover:opacity-90 text-primary-foreground px-8 py-6 text-lg rounded-xl shadow-medium hover:shadow-large transition-all duration-300 group"
